...
public class BusinessTransferPanel extends JPanel implements MouseListener {
		// 测试
		public static void main(String[] args) {
			BusinessTransferPanel a = new BusinessTransferPanel("test");
		 ...
		 * 转账信息面板
		 */
		public BusinessTransferPanel(String s) {
			this.s = s;
		...
		public void mouseClicked(MouseEvent e) {
			...
			if(e.getSource() == jl_add) {
				Transfer ta = new Transfer();
				new TransferInformationDialog(ta, 0, s);
